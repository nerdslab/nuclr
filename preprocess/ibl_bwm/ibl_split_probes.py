...
root = Path("../data/processed/ibl_brainwide_map_qc")
new_root = Path("../data/processed/ibl_brainwide_map_qc_probes")
new_brainset_id = "ibl_brainwide_map_qc_probes"
...
probes = np.unique(data.units.pid)
...
for i, probe in enumerate(probes):
    ...
    unit_mask = new_data.units.pid == probe
