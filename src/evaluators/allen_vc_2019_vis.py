...
class AllenVC2019VisEvaluator:
    ...
    def prep_md_df():
        ...
        df["unit_id"] = np.array([str(y) for y in df.unit_id])
        df["brain_region"] = df.ecephys_structure_acronym
    ...
    def __call__(
        ...
        banned_brs = ["VIS", "VISmma", "VISli", "VISmmp"]
        # VIS means fine-grained brain region within vis is unidentified
        # The rest have too few groung truth labels
